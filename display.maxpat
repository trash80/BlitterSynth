...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.875, 157.0, 91.25, 18.0 ],
					"text" : "raw wave display"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 86.875, 324.5, 91.25, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 296.0, 191.0, 32.5, 18.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 328.0, 191.0, 257.0, 18.0 ],
					"text" : "bang the window to send all values in new size"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 309.5, 219.0, 49.0, 16.0 ],
					"text" : "size $1"
				}
...
, 			{
				"box" : 				{
					"annotation" : "Set the size of the waveform displays",
					"comment" : "Sample Size (2-128)",
					"id" : "obj-40",
					"maxclass" : "inlet",
					"numinlets" : 0,
					"numoutlets" : 1,
